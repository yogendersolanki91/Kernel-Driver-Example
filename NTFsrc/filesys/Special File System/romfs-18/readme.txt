    ...
    This is a romfs file system driver for Windows.
   ...
   18. 2015-05-06
       Corrected an error in the calculation of the size of an romfs inode.

   17. 2015-05-06
       Corrected an error in the recognizing of romfs partitions.

   16. 2015-05-04
       Updated to pass all code analyzes in WDK 7.1.0.
       Can be compiled with either the DDK or the WDK.
       Improved FsdLookupFileName.
